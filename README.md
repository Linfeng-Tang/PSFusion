...
This is Pytorch implementation of " SegNeXt: Rethinking Convolutional Attention Design for Semantic Segmentation" in PSFusion.
...
2) Download the pre-processed MSRS and MFNet dataset from [MSRS]([https://pan.baidu.com/s/1Yv6QQ8IlobTHu288KTOCKg?pwd=MSRS](https://pan.baidu.com/s/1AjQSkRWYYMeBgT6IT9fOUw?pwd=MSRS )) and [MFNet](https://pan.baidu.com/s/1P4ccNtUQcCR1Mr8YBKy0qQ?pwd=MFNe), respectively. Then, put them  in **./datasets**
...
For a fast start tutorial, you can also refer to: [SegNext Guide](https://blog.csdn.net/fovever_/article/details/129121234?spm=1001.2014.3001.5502).
